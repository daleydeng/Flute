...
module mkCore(RST_N_dm_power_on_reset,
  ...
  assign cpu$EN_hart0_server_reset_response_get =
	     CAN_FIRE_RL_rl_cpu_hart0_reset_complete ;
  assign cpu$EN_trace_data_out_get = CAN_FIRE_RL_mkConnectionGetPut ;
  ...
  begin
    ...
    v__h4633 = v__h4639 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h4633);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h4431 = v__h4437 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h4431);
  end
  // synopsys translate_on
endmodule  // mkCore
