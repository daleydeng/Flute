...
module mkFabric_AXI4(CLK,
  ...
  wire [1 : 0] IF_fabric_v_rg_r_beat_count_0_47_EQ_fabric_v_f_ETC___d465,
	       ...
	       x1_avValue_rresp__h18500,
	       x1_avValue_rresp__h19211,
	       x1_avValue_rresp__h19912;
  ...
  assign x1_avValue_rresp__h18500 =
	     (fabric_xactors_to_slaves_0_f_rd_data$D_OUT[2:1] == 2'b0 &&
	      !fabric_xactors_to_slaves_0_f_rd_data$D_OUT[0]) ?
	       2'b10 :
	       fabric_xactors_to_slaves_0_f_rd_data$D_OUT[2:1] ;
  assign x1_avValue_rresp__h19211 =
	     (fabric_xactors_to_slaves_1_f_rd_data$D_OUT[2:1] == 2'b0 &&
	      !fabric_xactors_to_slaves_1_f_rd_data$D_OUT[0]) ?
	       2'b10 :
	       fabric_xactors_to_slaves_1_f_rd_data$D_OUT[2:1] ;
  assign x1_avValue_rresp__h19912 =
	     (fabric_xactors_to_slaves_2_f_rd_data$D_OUT[2:1] == 2'b0 &&
	      !fabric_xactors_to_slaves_2_f_rd_data$D_OUT[0]) ?
	       2'b10 :
	       fabric_xactors_to_slaves_2_f_rd_data$D_OUT[2:1] ;
  assign x__h11680 = fabric_v_rg_wd_beat_count_0 + 8'd1 ;
  assign x__h12343 = fabric_v_rg_wd_beat_count_1 + 8'd1 ;
  assign x__h18522 = fabric_v_rg_r_beat_count_0 + 8'd1 ;
  assign x__h19233 = fabric_v_rg_r_beat_count_1 + 8'd1 ;
  assign x__h19934 = fabric_v_rg_r_beat_count_2 + 8'd1 ;
  assign x__h22492 = fabric_v_rg_r_err_beat_count_0 + 8'd1 ;
  assign x__h22905 = fabric_v_rg_r_err_beat_count_1 + 8'd1 ;
  ...
  begin
    ...
    v__h10764 = v__h10770 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_wr_xaction_no_such_slave)
	$display("%0d: ERROR: rl_wr_xaction_no_such_slave: m%0d -> ?",
		 v__h10764,
		 $signed(32'd0));
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_wr_xaction_no_such_slave) $display("    %m");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_wr_xaction_no_such_slave) $write("        ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_wr_xaction_no_such_slave)
	$write("AXI4_Wr_Addr { ", "awid: ");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$write("'h%h", 1'd0, " }");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_wr_xaction_no_such_slave_1) $write("\n");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h17586 = v__h17592 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_rd_xaction_no_such_slave)
	$display("%0d: ERROR: rl_rd_xaction_no_such_slave: m%0d -> ?",
		 v__h17586,
		 $signed(32'd0));
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_rd_xaction_no_such_slave) $display("    %m");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_rd_xaction_no_such_slave) $write("        ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_rd_xaction_no_such_slave)
	$write("AXI4_Rd_Addr { ", "arid: ");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$write("'h%h", 1'd0, " }");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_rd_xaction_no_such_slave_1) $write("\n");
    if (RST_N != `BSV_RESET_VALUE)
