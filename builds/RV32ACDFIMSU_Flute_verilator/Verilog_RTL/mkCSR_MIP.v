...
module mkCSR_MIP(CLK,
  ...
  wire [31 : 0] mav_sip_write, mav_write, mv_read, mv_sip_read;
  ...
  // value method mv_read
  assign mv_read = { 20'd0, new_mip__h600 } ;

  // actionvalue method mav_write
  assign mav_write = { 20'd0, new_mip__h1072 } ;
