...
module mkBranch_Predictor(CLK,
  ...
  reg [31 : 0] _theResult_____1_fst__h7539,
	       _theResult_____1_fst__h7583,
	       pred_PC__h7444;
  reg [1 : 0] _theResult_____1_snd__h7540, _theResult_____1_snd__h7584;
  ...
  wire [31 : 0] _theResult_____1__h2388,
		_theResult_____1_fst__h7472,
		_theResult____h2387,
		pred_pc__h3359,
		pred_pc__h3361,
		ret_pc___1__h4116,
		ret_pc__h4078;
  wire [1 : 0] _theResult_____1_snd__h7473;
  ...
  // value method predict_rsp
  assign predict_rsp =
	     (_theResult_____1__h2388 == 32'hFFFFFFFF) ?
	       pred_pc__h3361 :
	       _theResult_____1__h2388 ;
  ...
  assign MUX_btb_bramcore2$b_put_1__SEL_1 =
	     EN_bp_train && pred_PC__h7444 != 32'hFFFFFFFF ;
  assign MUX_btb_bramcore2$b_put_3__VAL_1 =
	     { 1'd1, bp_train_cf_info[96:75], pred_PC__h7444[31:1] } ;
  always@(bp_train_cf_info or
	  rf_btb_fsms$D_OUT_1 or _theResult_____1_snd__h7473)
  begin
    case (bp_train_cf_info[98:97])
      2'd0: MUX_rf_btb_fsms$upd_2__VAL_1 = _theResult_____1_snd__h7473;
  ...
  assign IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d229 =
	     { IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d225,
	       bp_train_is_i32_not_i16 ? ret_pc__h4078 : ret_pc___1__h4116 } ;
  ...
  assign _theResult_____1__h2388 =
	     (_theResult____h2387 == 32'hFFFFFFFF && btb_bramcore2$DOA[53] &&
	      btb_bramcore2$DOA[52:31] == rg_pc[31:10]) ?
	       pred_pc__h3359 :
	       _theResult____h2387 ;
  assign _theResult_____1_fst__h7472 =
	     bp_train_cf_info[64] ?
	       _theResult_____1_fst__h7539 :
	       _theResult_____1_fst__h7583 ;
  assign _theResult_____1_snd__h7473 =
	     bp_train_cf_info[64] ?
	       _theResult_____1_snd__h7540 :
	       _theResult_____1_snd__h7584 ;
  assign _theResult____h2387 =
	     ((IF_predict_rsp_is_i32_not_i16_THEN_NOT_predict_ETC___d38 ||
	       IF_predict_rsp_is_i32_not_i16_THEN_NOT_predict_ETC___d55) &&
	      IF_predict_rsp_is_i32_not_i16_THEN_predict_rsp_ETC___d62 &&
	      (IF_predict_rsp_is_i32_not_i16_THEN_NOT_predict_ETC___d55 &&
  ...
  assign bp_train_instr_BITS_15_TO_12_25_EQ_0b1001_38_A_ETC___d157 =
	     ...
	     bp_train_instr[6:2] == 5'd0 &&
	     bp_train_instr[1:0] == 2'b10 ;
  assign pred_pc__h3359 = { btb_bramcore2$DOA[30:0], 1'b0 } ;
  assign pred_pc__h3361 =
  ...
  assign predict_rsp_instr_BITS_15_TO_12_9_EQ_0b1001_0__ETC___d33 =
	     ...
	     predict_rsp_instr[6:2] == 5'd0 &&
	     predict_rsp_instr[1:0] == 2'b10 ;
  assign ret_pc___1__h4116 = bp_train_pc + 32'd2 ;
  assign ret_pc__h4078 = bp_train_pc + 32'd4 ;
  always@(rf_btb_fsms$D_OUT_1 or bp_train_cf_info)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0: _theResult_____1_fst__h7539 = bp_train_cf_info[63:32];
      2'b01, 2'b10, 2'b11:
	  _theResult_____1_fst__h7539 = bp_train_cf_info[31:0];
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1 or bp_train_cf_info)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01, 2'b10:
	  _theResult_____1_fst__h7583 = bp_train_cf_info[63:32];
      2'b11: _theResult_____1_fst__h7583 = bp_train_cf_info[31:0];
    endcase
  end
  always@(bp_train_cf_info or _theResult_____1_fst__h7472)
  begin
    case (bp_train_cf_info[98:97])
      2'd0: pred_PC__h7444 = _theResult_____1_fst__h7472;
      2'd1, 2'd2: pred_PC__h7444 = bp_train_cf_info[31:0];
      2'd3: pred_PC__h7444 = 32'hFFFFFFFF;
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01: _theResult_____1_snd__h7584 = 2'b0;
      2'b10: _theResult_____1_snd__h7584 = 2'b01;
      2'b11: _theResult_____1_snd__h7584 = 2'b10;
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0: _theResult_____1_snd__h7540 = 2'b01;
      2'b01: _theResult_____1_snd__h7540 = 2'b10;
      2'b10, 2'b11: _theResult_____1_snd__h7540 = 2'b11;
    endcase
  end
